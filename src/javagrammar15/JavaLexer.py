# $ANTLR 3.1.2 Java.g 2010-08-25 21:59:11
...
class JavaLexer(Lexer):
    ...
    def mHEX_LITERAL(self, ):
        ...
        try:
            ...
            # Java.g:999:13: ( '0' ( 'x' | 'X' ) ( HEX_DIGIT )+ ( INTEGER_TYPE_SUFFIX )? )
            # Java.g:999:15: '0' ( 'x' | 'X' ) ( HEX_DIGIT )+ ( INTEGER_TYPE_SUFFIX )?
            pass 
            self.match(48)
            ...
            # Java.g:999:40: ( INTEGER_TYPE_SUFFIX )?
            alt2 = 2
    ...
    def mDECIMAL_LITERAL(self, ):
        ...
        try:
            ...
            # Java.g:1001:17: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( INTEGER_TYPE_SUFFIX )? )
            # Java.g:1001:19: ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( INTEGER_TYPE_SUFFIX )?
            pass 
            # Java.g:1001:19: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            alt4 = 2
            ...
            # Java.g:1001:46: ( INTEGER_TYPE_SUFFIX )?
            alt5 = 2
    ...
    def mOCTAL_LITERAL(self, ):
        ...
        try:
            ...
            # Java.g:1003:15: ( '0' ( '0' .. '7' )+ ( INTEGER_TYPE_SUFFIX )? )
            # Java.g:1003:17: '0' ( '0' .. '7' )+ ( INTEGER_TYPE_SUFFIX )?
            pass 
            self.match(48)
            # Java.g:1003:21: ( '0' .. '7' )+
            cnt6 = 0
            ...
            # Java.g:1003:33: ( INTEGER_TYPE_SUFFIX )?
            alt7 = 2
    ...
    def mHEX_DIGIT(self, ):
        ...
        try:
            # Java.g:1006:11: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            # Java.g:1006:13: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            pass 
    ...
    def mFLOATING_POINT_LITERAL(self, ):
        ...
        try:
            ...
            # Java.g:1012:5: ( ( '0' .. '9' )+ ( DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? | FLOAT_TYPE_SUFFIX ) | DOT ( '0' .. '9' )+ ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? )
            alt17 = 2
            ...
            if alt17 == 1:
                # Java.g:1012:9: ( '0' .. '9' )+ ( DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? | FLOAT_TYPE_SUFFIX )
                pass 
                # Java.g:1012:9: ( '0' .. '9' )+
                cnt8 = 0
                while True: #loop8
                ...
                # Java.g:1013:9: ( DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? | FLOAT_TYPE_SUFFIX )
                alt13 = 3
                ...
                if alt13 == 1:
                    # Java.g:1014:13: DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )?
                    pass 
                    self.mDOT()
                    # Java.g:1014:17: ( '0' .. '9' )*
                    while True: #loop9
                    ...
                    # Java.g:1014:39: ( FLOAT_TYPE_SUFFIX )?
                    alt11 = 2
                    ...
                    # Java.g:1015:13: EXPONENT ( FLOAT_TYPE_SUFFIX )?
                    pass 
                    self.mEXPONENT()
                    # Java.g:1015:22: ( FLOAT_TYPE_SUFFIX )?
                    alt12 = 2
                    ...
                    # Java.g:1016:13: FLOAT_TYPE_SUFFIX
                    pass 
                    self.mFLOAT_TYPE_SUFFIX()
                ...
                # Java.g:1018:9: DOT ( '0' .. '9' )+ ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )?
                pass 
                self.mDOT()
                # Java.g:1018:13: ( '0' .. '9' )+
                cnt14 = 0
                ...
                # Java.g:1018:35: ( FLOAT_TYPE_SUFFIX )?
                alt16 = 2
    ...
    def mEXPONENT(self, ):
        ...
        try:
            # Java.g:1022:10: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            # Java.g:1022:12: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            pass 
    ...
    def mFLOAT_TYPE_SUFFIX(self, ):
        ...
        try:
            # Java.g:1025:19: ( ( 'f' | 'F' | 'd' | 'D' ) )
            # Java.g:1025:21: ( 'f' | 'F' | 'd' | 'D' )
            pass 
    ...
    def mCHARACTER_LITERAL(self, ):
        ...
        try:
            ...
            # Java.g:1028:5: ( '\\'' ( ESCAPE_SEQUENCE | ~ ( '\\'' | '\\\\' ) ) '\\'' )
            # Java.g:1028:9: '\\'' ( ESCAPE_SEQUENCE | ~ ( '\\'' | '\\\\' ) ) '\\''
            pass 
            self.match(39)
            # Java.g:1028:14: ( ESCAPE_SEQUENCE | ~ ( '\\'' | '\\\\' ) )
            alt20 = 2
            ...
            if alt20 == 1:
                # Java.g:1028:16: ESCAPE_SEQUENCE
                pass 
    ...
    def mSTRING_LITERAL(self, ):
        ...
        try:
            ...
            # Java.g:1032:5: ( '\"' ( ESCAPE_SEQUENCE | ~ ( '\\\\' | '\"' ) )* '\"' )
            # Java.g:1032:8: '\"' ( ESCAPE_SEQUENCE | ~ ( '\\\\' | '\"' ) )* '\"'
            pass 
            self.match(34)
            # Java.g:1032:12: ( ESCAPE_SEQUENCE | ~ ( '\\\\' | '\"' ) )*
            while True: #loop21
                alt21 = 3
                ...
                if alt21 == 1:
                    # Java.g:1032:14: ESCAPE_SEQUENCE
                    pass 
                    self.mESCAPE_SEQUENCE()
    ...
    def mESCAPE_SEQUENCE(self, ):
        ...
        try:
            # Java.g:1037:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESCAPE | OCTAL_ESCAPE )
            alt22 = 3
            ...
            if alt22 == 1:
                ...
                # Java.g:1038:9: UNICODE_ESCAPE
                pass 
                self.mUNICODE_ESCAPE()


            elif alt22 == 3:
                # Java.g:1039:9: OCTAL_ESCAPE
                pass 
                self.mOCTAL_ESCAPE()
    ...
    def mOCTAL_ESCAPE(self, ):
        ...
        try:
            # Java.g:1044:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            alt23 = 3
    ...
    def mUNICODE_ESCAPE(self, ):
        ...
        try:
            # Java.g:1051:5: ( '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
            # Java.g:1051:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
            pass 
            self.match(92)
            self.match(117)
            self.mHEX_DIGIT()
    ...
    def mIDENT(self, ):
        ...
        try:
            ...
            # Java.g:1055:5: ( JAVA_ID_START ( JAVA_ID_PART )* )
            # Java.g:1055:9: JAVA_ID_START ( JAVA_ID_PART )*
            pass 
            self.mJAVA_ID_START()
            # Java.g:1055:23: ( JAVA_ID_PART )*
            while True: #loop24
                alt24 = 2
    ...
    def mJAVA_ID_START(self, ):
        ...
        try:
            # Java.g:1060:5: ( '\\u0024' | '\\u0041' .. '\\u005a' | '\\u005f' | '\\u0061' .. '\\u007a' | '\\u00c0' .. '\\u00d6' | '\\u00d8' .. '\\u00f6' | '\\u00f8' .. '\\u00ff' | '\\u0100' .. '\\u1fff' | '\\u3040' .. '\\u318f' | '\\u3300' .. '\\u337f' | '\\u3400' .. '\\u3d2d' | '\\u4e00' .. '\\u9fff' | '\\uf900' .. '\\ufaff' )
            # Java.g:
            pass 
    ...
    def mJAVA_ID_PART(self, ):
        ...
        try:
            # Java.g:1077:5: ( JAVA_ID_START | '\\u0030' .. '\\u0039' )
            # Java.g:
            pass 
    ...
    def mCOMMENT(self, ):
        ...
        try:
            ...
            pass 
            self.match("/*")
            # Java.g:1088:14: ( options {greedy=false; } : . )*
            while True: #loop25
                alt25 = 2
    ...
    DFA28_eot = DFA.unpack(
        u"\1\uffff\1\61\1\63\1\uffff\1\66\2\uffff\1\71\1\75\1\100\1\104"
        u"\2\uffff\1\107\1\111\1\114\1\uffff\1\116\6\uffff\1\120\1\122\17"
        u"\55\2\173\11\uffff\1\177\21\uffff\1\u0081\14\uffff\12\55\1\u008e"
        u"\7\55\1\u0096\23\55\1\uffff\1\u00b1\1\uffff\1\173\1\u00b3\4\uffff"
    ...
    DFA28_min = DFA.unpack(
        u"\1\11\1\46\1\75\1\uffff\1\75\2\uffff\1\55\2\52\1\53\2\uffff\1"
        u"\74\2\75\1\uffff\1\75\6\uffff\2\75\1\142\1\157\1\141\1\145\1\154"
        u"\1\141\1\146\1\157\2\141\1\145\2\150\1\157\1\150\2\56\11\uffff"
        u"\1\75\21\uffff\1\75\14\uffff\2\163\1\157\1\145\1\164\1\163\2\141"
    ...
    DFA28_transition = [
        DFA.unpack(u"\2\56\1\uffff\2\56\22\uffff\1\56\1\16\1\54\1\uffff"
        u"\1\55\1\21\1\1\1\53\1\20\1\26\1\30\1\12\1\6\1\7\1\11\1\10\1\51"
        u"\11\52\1\5\1\27\1\15\1\2\1\4\1\23\1\3\32\55\1\13\1\uffff\1\24\1"
        u"\31\1\55\1\uffff\1\32\1\33\1\34\1\35\1\36\1\37\2\55\1\40\2\55\1"
        u"\41\1\55\1\42\1\55\1\43\1\55\1\44\1\45\1\46\1\55\1\47\1\50\3\55"
        u"\1\14\1\17\1\25\1\22\101\uffff\27\55\1\uffff\37\55\1\uffff\u1f08"
        u"\55\u1040\uffff\u0150\55\u0170\uffff\u0080\55\u0080\uffff\u092e"
        u"\55\u10d2\uffff\u5200\55\u5900\uffff\u0200\55"),
        ...
        DFA.unpack(u"\1\157"),
        DFA.unpack(u"\1\160\13\uffff\1\161\1\162\1\uffff\1\163\1\uffff"
        u"\1\164"),
        ...
        u"\uffff\24\55\1\u008d\5\55\105\uffff\27\55\1\uffff\37\55\1\uffff"
        u"\u1f08\55\u1040\uffff\u0150\55\u0170\uffff\u0080\55\u0080\uffff"
        u"\u092e\55\u10d2\uffff\u5200\55\u5900\uffff\u0200\55"),
        DFA.unpack(u"\1\u008f"),
        DFA.unpack(u"\1\u0090"),
        ...
        DFA.unpack(u"\1\u00c9"),
        DFA.unpack(u"\1\55\13\uffff\12\55\7\uffff\32\55\4\uffff\1\55\1"
        u"\uffff\4\55\1\u00ca\25\55\105\uffff\27\55\1\uffff\37\55\1\uffff"
        u"\u1f08\55\u1040\uffff\u0150\55\u0170\uffff\u0080\55\u0080\uffff"
        u"\u092e\55\u10d2\uffff\u5200\55\u5900\uffff\u0200\55"),
        DFA.unpack(u"\1\u00cc"),
        DFA.unpack(u"\1\u00cd"),
        ...
        u"\uffff\u5200\55\u5900\uffff\u0200\55"),
        DFA.unpack(u"\1\55\13\uffff\12\55\7\uffff\32\55\4\uffff\1\55\1"
        u"\uffff\13\55\1\u0119\16\55\105\uffff\27\55\1\uffff\37\55\1\uffff"
        u"\u1f08\55\u1040\uffff\u0150\55\u0170\uffff\u0080\55\u0080\uffff"
        u"\u092e\55\u10d2\uffff\u5200\55\u5900\uffff\u0200\55"),
        DFA.unpack(u"\1\55\13\uffff\12\55\7\uffff\32\55\4\uffff\1\55\1"
        u"\uffff\32\55\105\uffff\27\55\1\uffff\37\55\1\uffff\u1f08\55\u1040"
        ...
        DFA.unpack(u""),
        DFA.unpack(u"\1\55\13\uffff\12\55\7\uffff\32\55\4\uffff\1\55\1"
        u"\uffff\22\55\1\u012c\7\55\105\uffff\27\55\1\uffff\37\55\1\uffff"
        u"\u1f08\55\u1040\uffff\u0150\55\u0170\uffff\u0080\55\u0080\uffff"
        u"\u092e\55\u10d2\uffff\u5200\55\u5900\uffff\u0200\55"),
        DFA.unpack(u"\1\u012e"),
        DFA.unpack(u""),
